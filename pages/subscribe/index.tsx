        ...
        <>
            <div className='outer-container  '>
                <div className='inner-container   '>
                    <div className='flex flex-col justify-center items-center space-y-6  w-full h-50'>
                        <p className='font-p36-FFFFFF-w600'>{t('subscrible.title')}</p>
                        <div className='relative w-57 mt-8.5 rounded-2xl bg-nb-2E2F30'>
                    ...
                    <div className='flex flex-row justify-center items-center space-x-14 w-full mt-22'  >
                        {
                                    ...
                                    <div key={index} className={` w-80 rounded-2xl bg-nb-sidebar-grey ${index === 1 ? "h-127" : "h-120"}`}>
                                        <div className='relative rounded-2xl h-20 w-full '><div className='absolute -top-5 left-4'>{data.svg}</div></div>
                                        {
                                            index === 0 ? <div className='flex flex-row h-25 w-full '>
                                                ...
                                                <div className='flex flex-row justify-end items-end mr-3  mt-1 w-30  '><p className='font-p40-FFFFFF-w700 mr-2 mb-3'>$</p><p className='font-p60-FFFFFF-w700 ' >3</p></div>
