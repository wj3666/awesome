        ...
        <>
            <div className='flex flex-row justify-center items-center w-screen h-screen  bg-bg-succeed'>
                <div className='flex flex-col items-center h-140 w-94.5 '>
                   ...
                   { router.locale === 'en' ? <p className='font-p26-FFFFFF-w400 font-sans'>Sign up succeed!</p>:<p className='font-p26-FFFFFF-w400 font-sans'>订阅成功</p>}
                    {router.locale === 'en' ? <p className='font-p26-FFFFFF-w400 font-sans'>Welcome to AwesomeIMG</p>:<p className='font-p26-FFFFFF-w400 font-sans'>欢迎来到 AwesomeIMG</p>}
                    </div>
