                    ...
                    <div className=' flex flex-row justify-center items-center bg-loginbg-left bg-cover w-full h-full '>
                        <div className='flex flex-col space-y-3 h-160 w-94.5   '>
                            ...
                            <div className='flex flex-col items-center  justify-start w-full h-18 '>
                                ...
                                <input type="text" onChange={(e) => { setUserName(e.target.value) }} value={emailVal} className={`w-full h-10.5 rounded-xl border px-10  bg-email-logo bg-no-repeat bg-left-2 border-nb-CFD0E466 bg-nb-CFD0E44D ${emailVal === '' ? "" : "font-p15-FFFFFF-w500"} `} placeholder="Name@xxxx.com" />
                            </div>
                            {
                            ...
                            <div className='relative items-center  justify-start w-full h-24 '>
                                ...
                                <input type={showpassword ? 'text' : 'password'} onChange={(e) => { setPassword(e.target.value) }} value={password} className={`w-full h-10.5 rounded-xl border px-10  bg-password-logo logo bg-no-repeat bg-left-2 border-nb-CFD0E466 bg-nb-CFD0E44D ${password === '' ? "" : "font-p15-FFFFFF-w500"} `} placeholder={t('header.login.passWordHint')} />
                            ...
                            <div className=' w-full h-6 flex flex-row justify-center '><p className='font-p15-C8C8C8-w500'>{t('header.login.account')} <span onClick={() => loginSignStore.onchangeLogSignView(1)} className='font-p15-4C90FE-w500 cursor-pointer'>{t('header.login.creatUser')}</span></p></div>
                            <div>
                                {
                ...
                <div className=' flex flex-col   justify-center items-center bg-paymentbg-right bg-cover h-full  w-5/12'>
                    <div className='flex flex-col justify-start  items-center  h-140 w-94.5 '>
                        ...
                        <div className='flex flex-col items-center h-60 w-94.5 space-y-4 '>
                            <p className='font-p26-FFFFFF-w400 font-sans w-100'>{t('header.loginRight.title')}</p>
                            <p className='font-p14-CFD0E4-w300 w-100'>{t('header.loginRight.content')}</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div className='flex flex-row justify-center items-center bg-loginbg-left bg-cover w-full h-full '>
                        <div className='flex flex-col space-y-3 h-160 w-94.5   '>
                            <div className='flex flex-col justify-center items-center space-y-2 w-full h-30 '>
                                <img className='w-50' src='/Logo_awesomeImg.svg' />
                                <p className='font-p15-C8C8C8-w500'>{t('header.login.title')}</p>
                            </div>
                            <div className='flex flex-col items-center  justify-start w-full h-18 '>
                                <p className='relative  h-7 w-full font-p15-CFD0E4-w500'>{t('header.login.email')}</p>
                                {/* <img src='/Vector.png' className='absolute'/> */}
                            ...
                            <div className='relative items-center  justify-start w-full h-30 '>
                                <p className='h-7 w-full font-p15-CFD0E4-w500'>{t('header.login.passWord')}</p>
                                <input type={showpassword ? 'password' : 'text'} onChange={(e) => { setPassword(e.target.value) }} value={password} className={`w-full h-10.5 rounded-xl border px-10  bg-password-logo logo bg-no-repeat bg-left-2 border-nb-CFD0E466 bg-nb-CFD0E44D ${password === '' ? "" : "font-p15-FFFFFF-w500"} `} placeholder={t('header.register.passWordHint')} />
                            ...
                            <div className=' w-full h-10 flex flex-row justify-center '><p className='font-p15-C8C8C8-w500'>{t('header.register.haveMember')} <span onClick={() => loginSignStore.onchangeLogSignView(0)} className='font-p15-4C90FE-w500 cursor-pointer'>{t('header.register.signIn')} </span></p></div>
