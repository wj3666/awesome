...
const RctangleTop = () => (
    <svg width="12" height="7" viewBox="0 0 12 7" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path fill-rule="evenodd" clip-rule="evenodd" d="M6 0L11.6569 5.65685L10.9026 6.4111L6 1.50849L1.09739 6.4111L0.343146 5.65685L6 0Z" fill="#CFD0E4" />
    </svg>

)
const RctangleDown = () => (
    <svg width="12" height="8" viewBox="0 0 12 8" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path fill-rule="evenodd" clip-rule="evenodd" d="M6 7.31372L0.343146 1.65687L1.09739 0.902619L6 5.80523L10.9026 0.902619L11.6569 1.65687L6 7.31372Z" fill="#CFD0E4" />
    </svg>
